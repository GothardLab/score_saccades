...
function y = readitmfile_general(x,varargin)
...
while 1
  ...
  if nrows ==1  
          ...
          if strcmp(colugnas{ncols},'------FILENAME------')              
           ...
           if strcmp(colugnas{11},'CENTERX')              
              y{1,3+morecol}=colugnas{11};
           end  
                     if strcmp(colugnas{12},'CENTERY')              
              y{1,4+morecol}=colugnas{12};
          end  
  end       
...
%           end          
          ...
          y{nrows,3+morecol}=colugnas{6};
          y{nrows,4+morecol}=colugnas{7};
      end 
  end     
